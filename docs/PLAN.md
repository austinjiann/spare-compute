...
guidance, revocation actions, setup guidance, empty-log placeholders, copyable
CLI log handoffs, and safe command parsing; a real Swift client has successfully
