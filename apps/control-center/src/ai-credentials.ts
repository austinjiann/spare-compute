...
async function saveAIPlannerCredentials(credentials: any = {}, options: any = {}) {
...
async function clearAIPlannerCredentials(options: any = {}) {
  try {
...
function credentialsStatus(credentials: any = {}, env = process.env) {
...
function plannerConfigFromCredentials(credentials: any = {}, env = process.env) {
...
function configuredModel(credentials: any = {}, env = process.env) {
  return cleanString(
    credentials.model ||
...
function configuredProvider(credentials: any = {}, env = process.env) {
  return plannerProvider(credentials.provider || env.COMPUTEHOP_AI_PROVIDER);
}

function configuredBaseURL(credentials: any = {}, env = process.env) {
  return cleanBaseURL(
    credentials.baseURL ||
...
function statusBaseURL(credentials: any = {}, env = process.env) {
...
function credentialsPath(options: any = {}) {
