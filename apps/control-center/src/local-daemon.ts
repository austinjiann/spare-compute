...
const LOCAL_PROTO_PATH = path.resolve(
  controlCenterRootForModule(__dirname),
  "..",
  "..",
  "api",
  "proto",
...
class LocalDaemonClient {
  ...
  async confirmPairing(pairingSelector, options: any = {}) {
    const response = await this.call(
      {
        confirmPairing: {
  ...
  async rejectPairing(pairingSelector, options: any = {}) {
    const response = await this.call(
      {
        rejectPairing: {
          pairingSelector: pairingSelector || ""
  ...
  async unpairDevice(deviceSelector, options: any = {}) {
    const response = await this.call(
      {
        unpairDevice: {
          deviceSelector: deviceSelector || ""
  ...
  async submitJob(jobRequest, options: any = {}) {
    const response = await this.call(
      {
        submitJob: {
          spec: {
  ...
  async getJobProgress(jobID, options: any = {}) {
    const response = await this.call(
      {
        getJobProgress: {
          jobId: jobID,
  ...
  async readJobLogs(jobID, options: any = {}) {
    const response = await this.call(
      {
        readJobLogs: {
          jobId: jobID,
  ...
  async cancelJob(jobID, options: any = {}) {
    const response = await this.call(
      {
        cancelJob: {
          jobId: jobID,
  ...
  async fetchArtifacts(jobID, options: any = {}) {
    const response = await this.call(
      {
        fetchArtifacts: {
          jobId: jobID,
  ...
  async call(operation, options: any = {}) {
...
function sendFramedRequest(socketPath, payload, options: any = {}) {
