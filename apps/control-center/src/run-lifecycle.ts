async function stopActiveRun(activeRuns, runID, options: any = {}) {
...
async function stopRunsForWebContents(activeRuns, webContents, options: any = {}) {
  return stopRunIDs(activeRuns, runIDsForWebContents(activeRuns, webContents), options);
}

async function stopAllRuns(activeRuns, options: any = {}) {
  return stopRunIDs(activeRuns, [...activeRuns.keys()], options);
}

async function stopRunIDs(activeRuns, runIDs, options: any = {}) {
  const results = [];
  for (const runID of runIDs) {
