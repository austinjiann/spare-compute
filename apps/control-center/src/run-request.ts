(function attachRunRequest(root, factory) {
...
}(typeof globalThis === "object" ? globalThis : window, function createRunRequest(outputPath: any = {}, deviceTargets: any = {}, capabilityCatalog: any = {}) {
  ...
  function jobStartRequestForPlan(request: any = {}) {
  ...
  function jobDeviceName(device: any = {}) {
  ...
  function jobWorkingDirectoryForPlan(request: any = {}) {
  ...
  function jobOutputsForPlan(request: any = {}) {
    const plan = request.plan || {};
  ...
  function runReadinessError(request: any = {}) {
    return runReadinessBlocker(request).message;
  }

  function runReadinessBlocker(request: any = {}) {
  ...
  function selectedDeviceBlocker(device: any = {}) {
  ...
  function targetPlatformBlocker(device: any = {}, plan: any = {}) {
  ...
  function targetArchitectureBlocker(device: any = {}, plan: any = {}) {
  ...
  function missingToolBlocker(device: any = {}, plan: any = {}) {
  ...
  function executorBlocker(device: any = {}, plan: any = {}) {
  ...
  function isRemoteWorker(device: any = {}) {
  ...
  function outputValidationForPlan(request: any = {}) {
    const plan = request.plan || {};
    if (plan.ignoreDeclaredOutputs) {
  ...
  function fallbackWorkerExecutorReadiness(_device: any = {}, plan: any = {}) {
