(function attachRunRecovery(root, factory) {
...
}(typeof globalThis === "object" ? globalThis : window, function createRunRecovery(deviceTargets: any = {}) {
  ...
  function workerTargetActionRequest(plan: any = {}, devices = [], options: any = {}) {
  ...
  function runControlCanRecover(blocker: any = {}, options: any = {}) {
  ...
  function pendingRunAfterPairing(plan: any = {}, worker: any = {}) {
  ...
  function pendingPairingRunTarget(pending = null, devices = [], options: any = {}) {
    if (!pending?.workerID) {
      return null;
    }
  ...
  function defaultIsPairable(device: any = {}) {
  ...
  function defaultIsRunnable(device: any = {}) {
  ...
  function fallbackConcreteDeviceID(device: any = {}) {
    if (!device) {
      return "local";
    }
