...
function bundleDaemon(options: any = {}) {
...
function goBuildArguments(options: any = {}, output = daemonOutputPath(options)) {
...
function releaseVersion(options: any = {}) {
  if (options.version) {
...
function goBuildEnvironment(options: any = {}) {
...
function daemonOutputPath(options: any = {}) {
